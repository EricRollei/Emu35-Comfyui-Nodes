...
**Fix Applied**: Updated to use the official chat-style template:
```
...
3. **Roadmap Items**: BAAI's TODO shows "Advanced image decoder" and "DiDA (Discrete Diffusion Adaptation)" as future features
