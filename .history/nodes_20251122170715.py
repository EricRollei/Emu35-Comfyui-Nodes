...
class Emu35Sampler:
    ...
    def generate(self, model, tokenizer, vq_model, prompt, negative_prompt, width, height, steps, cfg_scale, seed, input_image=None):
        ...
        # Enable optimizations for quantized inference
        with torch.inference_mode():  # More aggressive than no_grad for quantized models
            # Reduce memory fragmentation by clearing cache
