    ...
    def generate(self, model, tokenizer, vq_model, prompt, negative_prompt, width, height, steps, cfg_scale, seed, input_image=None):
        ...
        class DummyConfig:
            def __init__(self):
                ...
                self.h = height # Was latent_height
                self.w = width  # Was latent_width
                self.target_height = height # Was latent_height
                self.target_width = width   # Was latent_width
        ...
        print("Using standard model.generate() for correctness...")
