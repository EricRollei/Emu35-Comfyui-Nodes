...
class MockDynamicCache(transformers.cache_utils.Cache):
    def __init__(self):
        self.max_cache_len = 1024
        self.seen_tokens = 0 # Wait, user said seen_tokens is MISSING. So I should NOT define it.
        # But wait, Cache base class might have it? 
        # User error: AttributeError: 'DynamicCache' object has no attribute 'seen_tokens'
        pass
