...
def main():
    # Use absolute Windows path - transformers will handle it
    model_path = os.path.abspath(r"A:\model\Emu3.5-Image")
    device = "cuda:0"
    ...
    vq_model = build_vision_tokenizer(model_path).to(device).eval()
